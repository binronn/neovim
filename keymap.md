...
| `]d`           | 跳转到下一个警告             |
| `[d`           | 跳转到上一个警告             |
| `<leader>1`    | 跳转到第1个窗口仅调试生效    |
| `<leader>2`    | 跳转到第2个窗口仅调试生效    |
| `<leader>3`    | 跳转到第3个窗口仅调试生效    |
| `<leader>4`    | 跳转到第4个窗口仅调试生效    |
| `<leader>5`    | 跳转到第5个窗口仅调试生效    |
| `<leader>6`    | 跳转到第6个窗口仅调试生效    |
| `<leader>7`    | 跳转到第7个窗口仅调试生效    |
| `<leader>8`    | 跳转到第8个窗口仅调试生效    |
| `<leader>9`    | 跳转到第9个窗口仅调试生效    |
